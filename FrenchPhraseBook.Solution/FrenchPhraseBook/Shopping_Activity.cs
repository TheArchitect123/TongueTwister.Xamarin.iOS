...
{
    [Activity(Label = "Shopping")]
    public class Shopping_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new Shopping_Adapter(this, Speech_Model.SpeechActor, contentPage));
