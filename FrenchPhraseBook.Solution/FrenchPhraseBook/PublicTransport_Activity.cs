...
{
    [Activity(Label = "Public Transport")]
    public class PublicTransport_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            actionBar.Text = "Public Transport";
            ...
            contentPage.SetAdapter(new PublicTransport_Adapter(this, Speech_Model.SpeechActor, contentPage));
