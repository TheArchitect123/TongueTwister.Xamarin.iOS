...
{
    [Activity(Label = "Greetings")]
    public class Greetings_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            actionBar.Text = "Greetings";

            #region Speech
            TextToSpeech speech = new TextToSpeech(this, this);
            speech.SetLanguage(Java.Util.Locale.France);
            ...
            contentPage.SetAdapter(new Greetings_Adapter(this, Speech_Model.SpeechActor, contentPage));
