...
namespace FrenchPhraseBook
{
    ...
    public class Emergency_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new Emergency_Adapter(this, Speech_Model.SpeechActor, contentPage));
