...
{
    [Activity(Label = "Technology")]
    public class Technology_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new Technology_Adapter(this, Speech_Model.SpeechActor, contentPage));
