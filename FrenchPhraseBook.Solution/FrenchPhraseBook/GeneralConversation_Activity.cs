...
{
    [Activity(Label = "General Speech")]
    public class GeneralConversation_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new GeneralSpeech_Adapter(this, Speech_Model.SpeechActor, contentPage));
