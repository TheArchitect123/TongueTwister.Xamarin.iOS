...
{
    [Activity(Label = "Company & Business")]
    public class CompanyAndBusiness_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            actionBar.Text = "Company & Business";
            ...
            contentPage.SetAdapter(new Business_Adapter(this, Speech_Model.SpeechActor, contentPage));
