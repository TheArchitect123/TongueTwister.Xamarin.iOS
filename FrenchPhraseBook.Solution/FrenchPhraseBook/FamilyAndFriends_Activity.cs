...
{
    [Activity(Label = "Family & Friends")]
    public class FamilyAndFriends_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new FamilyFriends_Adapter(this, Speech_Model.SpeechActor, contentPage));
