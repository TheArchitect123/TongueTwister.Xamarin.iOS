...
{
    [Activity(Label = "Dating")]
    public class Dating_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new Dating_Adapter(this, Speech_Model.SpeechActor, contentPage));
