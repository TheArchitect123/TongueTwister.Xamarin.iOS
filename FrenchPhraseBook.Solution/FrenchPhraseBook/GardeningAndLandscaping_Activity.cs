...
{
    [Activity(Label = "Gardening & Landscaping")]
    public class GardeningAndLandscaping_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            actionBar.Text = "Gardening & Landscaping";
            ...
            contentPage.SetAdapter(new Gardening_Adapter(this, Speech_Model.SpeechActor, contentPage));
