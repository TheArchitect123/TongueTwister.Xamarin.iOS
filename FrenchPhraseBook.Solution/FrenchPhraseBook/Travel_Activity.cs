...
namespace FrenchPhraseBook
{
    ...
    public class Travel_Activity : Activity, TextToSpeech.IOnInitListener
    {
        #region Layouts 
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            contentPage.SetAdapter(new Travel_Adapter(this, Speech_Model.SpeechActor, contentPage));
